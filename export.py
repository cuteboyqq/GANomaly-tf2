...
def infer(test_dataset, w, SHOW_MAX_NUM, show_img, data_type):
    ...
    while(show_num < SHOW_MAX_NUM):
        ...
        g_loss,fake_img = detect_image(w, images, tflite=True,edgetpu=False)
...
if __name__=="__main__":
    ...
    if INFER:
        ...
        abnormal_test_data_dir = r'/home/ali/GitHub_Code/YOLO/YOLOV5-old/runs/detect/f_384_2min/crops_noline'
        ...
        line_loss = infer(test_dataset, w, SHOW_MAX_NUM, show_img, line_data_type)
